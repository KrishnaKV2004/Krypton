...
- **Fork the Repository**
  - Click the **Fork** button on the [Krypton Repository](https://github.com/KrishnaKV2004/Krypton.git)
- **Clone your forked repository**
  ```bash
  git clone https://github.com/KrishnaKV2004/Krypton.git
  cd Krypton
  ```
...
- **Add the original repository as an upstream remote**
  ```bash
  git remote add upstream https://github.com/KrishnaKV2004/Krypton.git
  ```
